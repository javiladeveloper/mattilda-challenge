...
class TestPaymentsCRUD:
    ...
    @pytest.mark.asyncio
    async def test_create_payment(self, auth_client: AsyncClient, invoice_id: str):
        ...
        response = await auth_client.post("/api/v1/payments", json=payment_data)
    ...
    @pytest.mark.asyncio
    async def test_create_payment_updates_invoice_status(self, auth_client: AsyncClient, invoice_id: str):
        ...
        invoice_response = await auth_client.get(f"/api/v1/invoices/{invoice_id}")
    ...
    @pytest.mark.asyncio
    async def test_payment_exceeds_pending_amount(self, auth_client: AsyncClient, invoice_id: str):
    ...
    @pytest.mark.asyncio
    async def test_list_invoice_payments(self, auth_client: AsyncClient, invoice_id: str):
        ...
        response = await auth_client.get(f"/api/v1/payments/invoice/{invoice_id}")
