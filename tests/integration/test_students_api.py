...
class TestStudentsCRUD:
    ...
    @pytest.mark.asyncio
    async def test_create_student(self, auth_client: AsyncClient, school_id: str):
    ...
    @pytest.mark.asyncio
    async def test_list_students(self, auth_client: AsyncClient, school_id: str):
    ...
    @pytest.mark.asyncio
    async def test_get_student_by_id(self, auth_client: AsyncClient, school_id: str):
    ...
    @pytest.mark.asyncio
    async def test_update_student(self, auth_client: AsyncClient, school_id: str):
    ...
    @pytest.mark.asyncio
    async def test_delete_student(self, auth_client: AsyncClient, school_id: str):
